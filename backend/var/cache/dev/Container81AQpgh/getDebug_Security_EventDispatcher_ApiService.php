...
class getDebug_Security_EventDispatcher_ApiService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [#[\Closure(name: 'security.logout.listener.cookie_clearing.api', class: 'Symfony\\Component\\Security\\Http\\EventListener\\CookieClearingLogoutListener')] fn () => ($container->privates['security.logout.listener.cookie_clearing.api'] ?? $container->load('getSecurity_Logout_Listener_CookieClearing_ApiService')), 'onLogout'], -255);
